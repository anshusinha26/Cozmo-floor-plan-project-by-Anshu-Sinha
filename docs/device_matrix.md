...
**Video runtimes come from the runs that produced the plans.** The video
tier's depth-scale step was once observed running about twelve times slower,
roughly a minute per frame with the device reported as `mps`, cause not
